...
public class MapsDemo6 {
    public static void main(String[] args) {
        ...
        Collection<String> values= studentsMap.values();  //values are names here // keys are numbers not inside the values
        System.out.println(values);                        // map can store both things , keys & values
